...
export const createStorySchema = z
	.object({
		...
		image_1: z.instanceof(File, { message: 'Image is required.' }),
		image_2: z.instanceof(File, { message: 'Image is required.' }),
		image_3: z.instanceof(File, { message: 'Image is required.' }),
